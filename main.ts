...
const UUID: string = Deno.env.get("UUID") || "47a6aadb-17ba-42a3-b60f-4ca21f304c97";
const SUB_PATH: string = Deno.env.get("SUB_PATH") || "sub123";  
const XPATH: string = Deno.env.get("XPATH") || "xhttp";
const DOMAIN: string = Deno.env.get("DOMAIN") || "deno.hero.xx.kg";
